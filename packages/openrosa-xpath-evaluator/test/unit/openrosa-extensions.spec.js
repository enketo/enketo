...
describe('openrosa-extensions', () => {
    it('should have expected functions', () => {
        assert.containsAllKeys(extensions.func, ['max', 'randomize']);
    });
            ...
            [
                ...
                [
                    ...
                    new Date(1970, 0, 1),
                    {
                        ...
                        lhs: wrapVal(1),
                        op: opVals.PLUS,
                        rhs: wrapVal(0.2916666666666667),
                    },
                ], // correctness of decimals tbd later
                ...
                [
                    ...
                    new Date(2012, 6, 24),
                    {
                        ...
                        rhs: wrapVal(15545.2916666666666667),
                    },
                ], // correctness of decimals tbd later
                [
                    new Date(1970, 0, 1),
                    ...
                    {
                        t: 'continue',
                        lhs: wrapVal(0.2916666666666667),
                        op: opVals.PLUS,
                        rhs: wrapVal(1),
                    },
                ], // correctness of decimals tbd later
                ...
                [
                    '2018-06-25',
                    '=',
                    '2018-06-25T00:00:00.000-07:00',
                    {
                        t: 'continue',
                        lhs: wrapVal(17707.291666666668),
                        op: opVals.EQ,
                        rhs: wrapVal(17707.291666666668),
                    },
                ],
                ...
                [
                    '2018-06-25',
                    '<',
                    '2018-06-25T00:00:00.001-07:00',
                    {
                        t: 'continue',
                        lhs: wrapVal(17707.291666666668),
                        op: opVals.LT,
                        rhs: wrapVal(17707.29166667824),
                    },
                ],
    ...
    describe('func', () => {
        ...
        describe('date()', () => {
            ...
            [true, false, 'some string'].forEach((arg) => {
                it(`should convert ${arg} to an Invalid date`, () => {
                    ...
                    // then
                    assert.isTrue(Number.isNaN(Number(res.v)));
        ...
        describe('format-date()', () => {
            [
                ...
                [
                    '(2015/10/01)',
                    new Date('2015-10-01T00:00:00.000'),
                    '(%Y/%m/%d)',
                ],
            ...
            [['1999-12-12'], []].forEach((args) => {
                it(`should throw an error when ${JSON.stringify(
                    args
                )} is provided`, () => {
                    assert.throws(
                        () => formatDate(...args.map(wrapVal)),
                        'format-date() :: not enough args'
                    );
                });
            });
        });
