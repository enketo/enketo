...
describe('decimal-time()', () => {
    it('decimates times', () => {
        assertNumberValue('decimal-time("06:00:00.000-07:00")', 0.25);
        assertNumberValue('decimal-time("06:00:00.000-01:00")', 0.0);
        assertNumberValue(
            'decimal-time("06:00:59.000-07:00")',
            0.25068287037037035
        );
        assertNumberValue(
            'decimal-time("23:59:00.000-07:00")',
            0.9993055555555556
        );
        assertNumberValue(
            'decimal-time("23:59:00.000-13:00")',
            0.24930555555555556
        );
    ...
    it('should convert times provided with a node parameter', () => {
      ...
      <data>
        ...
        assertNumberValue(doc, null, 'decimal-time( /data/a )', 0.25);
    });
