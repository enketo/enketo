...
describe('native nodeset functions', () => {
    ...
    describe('position()', () => {
      ...
      <html xml:lang="en-us" xmlns="http://www.w3.org/1999/xhtml" xmlns:ev="http://some-namespace.com/nss">
        ...
        [['*[position()=-1]', '']].forEach(([expr, expected]) => {
            it(`should evaluate ${expr} as ${expected}`, () => {
    ...
    it('local-name()', () => {
      ...
      <html xml:lang="en-us" xmlns="http://www.w3.org/1999/xhtml" xmlns:ev="http://some-namespace.com/nss">
        ...
        const input = [
            ...
            [
                'local-name(self::node())',
                doc.getElementById('testFunctionNodesetElement'),
                'div',
            ], // element
            [
                'local-name()',
            ...
            [
                'local-name()',
                doc.getElementById('testFunctionNodesetElementPrefix')
                    .firstChild,
                'div2',
            ], // element
            [
                'local-name(node())',
                doc.getElementById('testFunctionNodesetElementNested'),
                'span',
            ], // element nested
            [
                'local-name(self::node())',
            ...
            [
                'local-name()',
                doc.getElementById('testFunctionNodesetComment').firstChild,
                '',
            ], // comment
            [
                'local-name()',
                doc.getElementById('testFunctionNodesetText').firstChild,
                '',
            ], // text
            [
                'local-name(attribute::node())',
                nodeWithAttributes,
                nodeAttributes[0].nodeName,
            ], // attribute
            [
                `local-name(attribute::node()[${nodeAttributesIndex + 1}])`,
                nodeWithAttributes,
                'class',
            ], // attribute
        ];
        ...
        node = doc.getElementById(
            'testFunctionNodesetProcessingInstruction'
        ).firstChild;
    ...
    it('namespace-uri()', () => {
      ...
      <html xml:lang="en-us" xmlns="http://www.w3.org/1999/xhtml" xmlns:ev="http://some-namespace.com/nss">
        ...
        const input = [
            ...
            [
                `namespace-uri(attribute::node()[${nodeAttributesIndex + 1}])`,
                nodeWithAttributes,
                'http://some-namespace.com/nss',
            ], // attribute
            [
                'namespace-uri(namespace::node())',
                doc.getElementById('testFunctionNodesetNamespace'),
                '',
            ], // namespace
            [
                'namespace-uri(namespace::node()[2])',
                doc.getElementById('testFunctionNodesetNamespace'),
                '',
            ], // namespace
        ];
    ...
    it('name()', () => {
      ...
      <html xml:lang="en-us" xmlns="http://www.w3.org/1999/xhtml" xmlns:ev="http://some-namespace.com/nss">
        ...
        const input = [
            ...
            [
                `name(attribute::node()[${nodeAttributesIndex + 1}])`,
                nodeWithAttributes,
                'ev:class',
            ], // attribute
            [
