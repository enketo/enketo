    ...
    it('works with different types of context parameters', () => {
        ...
        [
            ...
            [
                '.',
                filterAttributes(
                    doc.getElementById('testContextNodeParameter').attributes
                )[0],
                2,
            ], // Attribute
            [
                '.',
                doc.getElementById('testContextNodeParameterText').firstChild,
                3,
            ], // Text
            [
                '.',
                doc.getElementById('testContextNodeParameterCData').firstChild,
                4,
            ], // CDATASection
            [
                '.',
                doc.getElementById(
                    'testContextNodeParameterProcessingInstruction'
                ).firstChild,
                7,
            ], // ProcessingInstruction
            [
                '.',
                doc.getElementById('testContextNodeParameterComment')
                    .firstChild,
                8,
            ], // Comment
        ].forEach((t) => {
